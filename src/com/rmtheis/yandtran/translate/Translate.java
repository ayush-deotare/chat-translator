...
public final class Translate extends YandexTranslatorAPI {
  ...
  public static void main(String[] args) {
    try {
      Translate.setKey("trnsl.1.1.20151029T160213Z.21345e606a4b800b.6453006cfd784e7f286ec543a4891e05a81e6331");
      String translation = Translate.execute("The quick brown fox jumps over the lazy dog.", Language.ENGLISH, Language.HINDI);
  ...
  public static String translate(final String text, final String from, final Language to) throws Exception {
	  validateServiceState(text); 
	    final String params = 
	        PARAM_API_KEY + URLEncoder.encode(apiKey,ENCODING) 
	        + PARAM_LANG_PAIR + URLEncoder.encode(from.toString(),ENCODING) + URLEncoder.encode("-",ENCODING) + URLEncoder.encode(to.toString(),ENCODING) 
